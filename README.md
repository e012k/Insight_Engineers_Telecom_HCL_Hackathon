...
---
✅ Use Case 1: Revenue Calculation
🎯 Objective
Calculate revenue per call and overall
---
🔧 Steps
1. Source
Cleaned data
...
```
👉 Meaning:
If Data Task 1 (Mapping Task1)is successful, then:
Run Data Task 2(Mapping Task2)
...
```
👉 Meaning:
If Data Task 1 fails (status ≠ 1):
Do NOT run Data Task 2
Send failure alert
End workflow
---
📧 Email Trigger Logic
...
```
---
⚠️ Optional Enhancement (After DT2)
Add another Decision Task:
📌 Condition:
```text id="g5w2nr"
Rejected_Percentage > 20
```
Flow:
```text id="t6k9yx"
DT2(Mapping Task2) → Decision → Warning Email → End
```
---
🚀 Final Flow
```text id="v8s4qm"
